class App {
  ...
  createNewTask() {
    ...
    ].dataset.id; //we can find the selected option then grab the id stored as a dataset
  ...
  render() {
    this.lists.length === 0
      ...
      : (this.createTaskForm.style.display = "block"); //hide the new task form if there are no lists to associate it with
